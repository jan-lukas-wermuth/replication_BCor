...
```{r data}
load("~/Dropbox/DimitriadisPohleWermuth/Binary Correlation/replication_BCor/application/data_pqr/pqr_arr.RData")
```
...
ggsave(filename = "~/Dropbox/DimitriadisPohleWermuth/Binary Correlation/replication_BCor/application/plots/drugs_comparison.pdf", height = 200 - adj_height, width = (1+sqrt(5))/2*200 - adj_width, device = "pdf", units = "mm")
```
...
ggsave(filename = "~/Dropbox/DimitriadisPohleWermuth/Binary Correlation/replication_BCor/application/plots/QCPhi_application_inference.pdf", height = 200, width = (1+sqrt(5))/2*200, device = cairo_pdf, units = "mm")
...
ggsave(filename = "~/Dropbox/DimitriadisPohleWermuth/Binary Correlation/replication_BCor/application/plots/QCPhi_application_inference_final.pdf", height = 200, width = (1+sqrt(5))/2*200, device = cairo_pdf, units = "mm")
```
...
ggsave(filename = "~/Dropbox/DimitriadisPohleWermuth/Binary Correlation/replication_BCor/application/plots/QCPhi_application_inference_meth.pdf", height = 200, width = (1+sqrt(5))/2*200, device = cairo_pdf, units = "mm")
...
ggsave(filename = "~/Dropbox/DimitriadisPohleWermuth/Binary Correlation/replication_BCor/application/plots/QCPhi_application_inference_meth_final.pdf", height = 200, width = (1+sqrt(5))/2*200, device = cairo_pdf, units = "mm")
```
